...
class info_joueur(object):
    def __init__(self,nom = "",sal = 50,cash = 1000,econo = 50,loyer = 10,ent = 0,chp = 50,dt = [],invest = [],bb = 0,t_dp = 10,liste_depense = [],iu = None):
        ...
        self.revenu_passif = 0
        self.actualisation_profil(nom,sal,cash,econo,loyer,ent,chp,dt,invest,t_ent,bb,t_dp,liste_depense)
        self.interface = None
    ...
    def actualisation(self):
        ...
        self.actualisation_profil(self.nom,self.salaire,self.cash,self.economies,self.loyer,self.liste_entre,self.cheque_de_paie,
                                  self.dettes,self.investissement,self.total_entrees,self.nb_bebe,self.total_depenses,self.liste_depense)
        self.iu.actualisation_info()
        
    
    def actualisation_profil(self,nom,sal,cash,econo,loyer,l_ent,chp,dt,invest,t_ent,bb,t_dp,l_dp):
        self.nom = nom
        self.salaire = sal
        self.cash = cash
        ...
        self.revenu_passif = self.total_entrees - self.salaire
