...
try:
    ...
    from iu_marche import igu_marche
    from iu_paycheck import igu_cashflow_day
    ...
    from vue.carte.iu_marche import igu_marche
    from vue.carte.iu_paycheck import igu_cashflow_day


class igu_espacejeu(Ui_MainWindow):
    def __init__(self,espaces):
        ...
        self.gui_paycheque = igu_cashflow_day(frame_paycheque,dashboard = self.dashboard,lancer=self.gui_rolldice)
    ...
    def init_espace(self):
        self.rate_race = [[650,570,21,21,"cheque_de_paie"],[610,560,21,21,"opportunite"],[580,540,21,21,"doodad"],[560,520,21,21,'opportunite'],[540,490,21,21,"bebe"],[530,460,21,21,"opportunite"],[530,420,21,21,"marche"],[540,390,21,21,"opportunite"],[560,360,21,21,"cheque_de_paie"],[580,340,21,21,"opportunite"],[610,320,21,21,"marche"],[640,310,21,21,"opportunite"],[680,310,21,21,"doodad"],[710,320,21,21,"opportunite"],[740,340,21,21,'bebe'],[770,360,21,21,"opportunite"],[780,390,21,21,"cheque_de_paie"],[790,420,21,21,"opportunite"],[790,460,21,21,"marche"],[780,490,21,21,"opportunite"],[770,520,21,21,"doodad"],[740,540,21,21,"opportunite"],[710,560,21,21,"reduction_de_taille"],[680,570,21,21,"opportunite"]]
        self.fast_track = [[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]
    ...
    def actualisation_info(self):
        ...
        self.actualisation_responsabilite(donnees["investissement"],donnees["loyer"],donnees["dettes"],donnees["bebe"])
        ...
        self.actualisation_entree_t(donnees["total_entre"])
    ...
    def actualisation_investissement(self,liste_inv):
        ...
        self.listWidget_entrees_2.addItems([inv["nom"]+"        "+str(int(inv["cashflow"])) for inv in liste_inv])#investissement
    
    def actualisation_responsabilite(self,liste_inv,loyer,dettes,bebe):
        # ajout des investisements ayant un cashflow negatif
        self.listWidget_depenses_2.addItems([inv["nom"]+"        "+str(inv["cashflow"]) for inv in liste_inv if inv["cashflow"]<0])
        #ajout du loyer
        self.listWidget_investissements_2.addItem("loyer : "+str(int(loyer)))
        # ajout de la dettes
        self.listWidget_depenses_2.addItem("dettes : "+str(int(self.som_depense_dettes(dettes))))    
        #ajout du nombre de bebe
        self.listWidget_depenses_2.addItem("nombre de bebe : "+str(bebe))
